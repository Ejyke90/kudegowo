      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
          ...
          <div className="mb-6 p-4 bg-blue-50 rounded-lg border border-blue-200">
            <p className="text-sm font-medium text-blue-800 mb-3">🎯 Demo Accounts (click to fill)</p>
            <div className="space-y-2">
              {DEMO_ACCOUNTS.map((account) => (
                <button
                  ...
                  className="w-full text-left px-3 py-2 text-sm bg-white rounded border border-blue-200 hover:bg-blue-100 transition-colors"
                >
            ...
            <div>
              ...
              <div className="mt-1">
                <input
                  ...
                  className="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 text-gray-900 bg-white focus:outline-none focus:ring-primary focus:border-primary sm:text-sm"
                  placeholder="ada.okonkwo@demo.com"
                />
              </div>
            </div>
