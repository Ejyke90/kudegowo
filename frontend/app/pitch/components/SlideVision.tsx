...
export function SlideVision() {
  return (
    <SlideWrap>
      <Tag>Our Vision</Tag>
      <H1>Nigeria's education & payments platform</H1>
      ...
      <div className="grid grid-cols-3 gap-6 mb-8">
        {[
          ...
          <div key={p.title} className={`bg-gradient-to-b ${p.col} border ${p.border} rounded-2xl p-6`}>
            ...
            <h3 className="font-black text-base text-white mb-1">{p.title}</h3>
      ...
      <div className="bg-gradient-to-r from-emerald-900/30 to-blue-900/20 border border-emerald-500/20 rounded-2xl p-5 flex items-center gap-6">
        ...
        <div>
          ...
          <p className="text-white/50 text-xs leading-relaxed">
            A school adopts payments → parents join → children get wallets → Safe School adds security value → data enables academic tools → the platform becomes indispensable. Each layer makes the next one easier to sell.
          </p>
        </div>
      </div>
    </SlideWrap>
