      ...
      <form onSubmit={handleSubmit} className="p-4 border-t">
        <div className="flex gap-2">
          <input
            ...
            className="flex-1 px-4 py-3 bg-white text-gray-900 placeholder-gray-400 rounded-full text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500 disabled:opacity-50 border border-gray-300"
          />
          <button
            type="submit"
