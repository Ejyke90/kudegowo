          ...
          <div className="mt-10">
            <dl className="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
              {services.map((service) => (
                <div 
                  key={service.name} 
                  className={`relative ${service.name === 'Cashless Payments' ? 'cursor-pointer hover:bg-gray-100 rounded-lg p-4 transition-colors' : ''}`}
                  ...
                  <dt>
                    ...
                    <p className="ml-16 text-lg leading-6 font-medium text-gray-900">
                      ...
                      {service.name === 'Cashless Payments' && (
                        <span className="ml-2 text-sm text-blue-600">(Click to pay)</span>
                      )}
                    </p>
                  </dt>
